...
function JoinPageContent() {
  ...
  const handleLogin = () => {
          router.push(`/api/auth/login?returnTo=${encodeURIComponent(`/link/${group_id}`)}`);
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-background text-foreground">
      <main className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-xl mb-8">
          ...
          Our platform offers a space for collaboration, learning, and growth. Whether you&apos;re a seasoned
          professional or just starting out, there&apos;s a place for you here.
        </p>
        {!currentUser ? (
          <button
          ...
          <JoinButton user={currentUser} groupId={groupId} />
        )}
      </main>
    </div>
  );
